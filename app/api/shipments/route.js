...
function buildPearsonShipments() {
  ...
  return [
    ...
    { ref:'PH-8832', route:'Leeds → London (M1)', status:'disrupted', eta:'???', sla_window:window(r2SlaStart,60), carrier:'Pearson Haulage', cargo_type:'mixed retail', cargo_value:18500, penalty_if_breached:2400, alert:'M1 breakdown — recovery dispatched', drops:1 },
