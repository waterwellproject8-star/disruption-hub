...
OUTPUT — return ONLY this JSON, no preamble or markdown:
{
  ...
  "body_html": "string — HTML body using only <p>, <ul>, <li>, <strong>, <table>, <tr>, <td>, <th>",
...
3. Itemised list of each discrepancy:
   - The invoice line and job_ref where applicable
   - Charged £X.XX vs Contracted £Y.YY (cite contract_ref from evidence string)
   - Delta £Z.ZZ
   - Brief operational note where the evidence summary adds defensive weight
     (e.g. POD captured, shipment completed within SLA) — but do NOT include
     unrelated breakdown counts from the events array, only directly-relevant facts
